...
public class PlayerFourScrit : MonoBehaviour {
		...
		void Update()
		{
			...
			if (playerIndex == PlayerIndex.Four && prevState.Buttons.A == ButtonState.Released && state.Buttons.A == ButtonState.Pressed)
			{
			...
			if (playerIndex == PlayerIndex.Four && prevState.Buttons.A == ButtonState.Pressed && state.Buttons.A == ButtonState.Released)
			{
